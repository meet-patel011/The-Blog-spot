A clean and interactive blog platform where users can create posts, filter by category, search content, and leave comments. Built entirely with HTML, CSS, and JavaScript.
